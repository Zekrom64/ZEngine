...
public class Matrix4x4Float extends Matrix3x3Float implements Matrix4x4<Float> {
	
	public float m0x3, m1x3, m2x3, m3x0, m3x1, m3x2, m3x3;
	
	public Matrix4x4Float() {}
	
	public Matrix4x4Float(
			float m0x0, float m0x1, float m0x2, float m0x3,
	...
	public Matrix4x4Float(float[] values) {
		m0x0 = values[0];
		m0x1 = values[1];
		m0x2 = values[2];
		m0x3 = values[3];
