...
public class StructUtils {
	...
	/** Attempts to instantiate a LWJGL or BridJ struct. If the instantiation fails, the
	 * error is passed to the internal exception handler, and null is returned.
	 * 
	 * @param structClass
				...
				supplier = new Supplier<Object>() {
					...
					public Object get() {
						try {
							...
							ZEngineInternalException.throwInternallyNoExcept("Failed to instantiate struct", e);
							return null;
						}
					}
	...
	/** Attempts to instantiate a LWJGL struct buffer. If the instantiation fails, the
	 * error is passed to the internal exception handler, and null is returned.
	 * 
					...
					public Object createStructBuffer(int length) {
						...
						try {
							return ctor.newInstance(buf);
								...
								IllegalArgumentException |
								InvocationTargetException e) {
							ZEngineInternalException.throwInternallyNoExcept("failed to instantiate struct buffer", e);
							return null;
						}
					}
