...
public class ZEDynList implements ZEByteable, ZERawSaveable, Cloneable {
	 ...
	 */
	public ZEDynList(byte[] bytes) throws IOException {
	 ...
	 */
	public boolean equals(ZEDynList data) {
	...
	public boolean equals(Object o) {
		if (o instanceof ZEDynList) {
			return equals((ZEDynList)o);
		} else return false;
	}
	
	public ZEDynList clone() {
		ZEDynList newdata = new ZEDynList();
